...
> outcome: site published successfully`}
          ...
          <section id="skills" className="section">
            <div className="section-head">
              <h2>Skills</h2>
              <p>
                Focused on practical troubleshooting and clean documentation.
              </p>
            </div>
          ...
          <section id="docs" className="section">
            ...
            <div className="grid">
              ...
              <Card
                title="Runbook: Deploy Vite React to GitHub Pages"
                meta="doc"
              >
                <p>
                  Set Vite base path → build → deploy to gh-pages → select
                  branch in Pages settings.
                </p>
              </Card>
            </div>
          </section>
          ...
          <footer className="footer">
            <span>
              © {new Date().getFullYear()} Camille West — built with React +
              Vite
            </span>
          </footer>
        </main>
